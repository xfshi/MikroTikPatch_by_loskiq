...
if __name__=='__main__':
    ...
    licgenros_parser = subparsers.add_parser('licgenros',help='Generate RouterOS License')
    ...
    licgenchr_parser = subparsers.add_parser('licgenchr',help='Generate CHR License')
    ...
    licparseros_parser = subparsers.add_parser('licparseros',help='Parse RouterOS License')
    licparseros_parser.add_argument('license',type=str, help='License String. Format: 66c1aRpjM52VlmgwPWQv6b6DPwX3vyg+vxlgb+ebXMP2K5A0Ei2mr5m+wHLUqrqmTNz7shFjNJAaMjXK3zXvIA==')
    ...
    if args.command =='genkey':
        ...
        print(f'export CUSTOM_NPK_SIGN_PRIVATE_KEY="{eddsa_private_key.hex()}"')
        print(f'export CUSTOM_NPK_SIGN_PUBLIC_KEY="{eddsa_public_key.hex()}"')
        kcdsa_private_key, kcdsa_public_key = generate_kcdsa_keypair()
        print(f'export CUSTOM_LICENSE_PRIVATE_KEY="{kcdsa_private_key.hex()}"')
        print(f'export CUSTOM_LICENSE_PUBLIC_KEY="{kcdsa_public_key.hex()}"')
